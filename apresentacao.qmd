...
::: fragment
-   Objetivo: compreender o papel do telegram na produção e compartilhamento de desinformação em brasileiros de extrema-direita
:::
...
<p class="texto-centrado" style="font-size: 12px;">
...
::: fragment
-   `R` é uma linguagem de programação voltada à análise estatística e visualização gráfica
:::
