...
<h4><p style="display: none;">TSE –</p>O que é *Desinformação?*</h4>

::: fragment
- [TSE](https://www.justicaeleitoral.jus.br/desinformacao/arquivos/Anexo_2177865_Guia_basico_de_enfrentamento_a_desinformacao_WEB_SEPREVOK.pdf)

>compreende todas as declarações públicas baseadas em informações, premissas ou dados incorretos, independentemente da intenção de quem as produziu ou as encaminhou

>[...] o emprego de informações parcialmente verdadeiras, mas deturpadas por manipulações de conteúdo ou contexto, com o objetivo de gerar desaprovação ou debilitar a imagem das instituições eleitorais.

:::

---

<h4><p style="display: none;">AUTOR –</p>O que é *Desinformação?*</h4>
...
<h4 style="text-align: center; display: none;"> Desinformação `!=` *Fake news*</h4>

![](dados/desinformacao.png)
