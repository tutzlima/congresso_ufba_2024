...
> IMAGEM DO LAYOUT DO ATLAS.TI

:::

---

### `ElasticSearch` & `Kibana` <br> Impactos metodológicos para análise de Violência Política no Telegram
...
-   Email: [ruan.lima\@ufba.br](ruan.lima@ufba.br)<br>

-   Github: <https://github.com/tutzlima><br>
