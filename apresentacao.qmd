...
#### Análise quantitativa e<br>Operações computacionais com `R` {.texto-centrado}
...
##### ELT do Telegram {.texto-centrado}

::: fragment
- Extração por meio do `Pyrogram`
:::
...
::: fragment
- Transformação no SQL
:::

::: fragment
- Ingestão dos dados no `ElasticSearch`
:::

------------------------------------------------------------------------

##### Imagem ELT do Telegram {.texto-invisivel}

<br>

[![](https://revista.internetlab.org.br/wp-content/uploads/2023/01/Captura-de-Tela-2023-01-16-a%CC%80s-13.13.20-1024x392.png)](https://revista.internetlab.org.br/publicos-refratados-grupos-de-extrema-direita-brasileiros-na-plataforma-telegram/)
...
#### Guilherme Boulos em `chats` do `Telegram` {.texto-centrado}
...
::: fragment
- *[Guilherme Boulos](dados/boulos.pdf)*
:::
